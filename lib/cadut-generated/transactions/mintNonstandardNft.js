...
/**
* Method to generate cadence code for mintNonstandardNft transaction
* @param {Object.<string, string>} addressMap - contract name as a key and address where it's deployed as value
*/
export const mintNonstandardNftTemplate = async (addressMap = {}) => {
  ...
  reportMissingImports(CODE, fullMap, `mintNonstandardNft =>`)
...
/**
* Sends mintNonstandardNft transaction to the network
* @param {Object.<string, string>} props.addressMap - contract name as a key and address where it's deployed as value
* @param Array<*> props.args - list of arguments
* @param Array<*> props.signers - list of signers
*/
export const mintNonstandardNft = async (props = {}) => {
  const { addressMap, args = [], signers = [] } = props;
  const code = await mintNonstandardNftTemplate(addressMap);

  reportMissing("arguments", args.length, 7, `mintNonstandardNft =>`);
  reportMissing("signers", signers.length, 1, `mintNonstandardNft =>`);
