...
/**
* Method to generate cadence code for addToNftCatalog transaction
* @param {Object.<string, string>} addressMap - contract name as a key and address where it's deployed as value
*/
export const addToNftCatalogTemplate = async (addressMap = {}) => {
  ...
  reportMissingImports(CODE, fullMap, `addToNftCatalog =>`)
...
/**
* Sends addToNftCatalog transaction to the network
* @param {Object.<string, string>} props.addressMap - contract name as a key and address where it's deployed as value
* @param Array<*> props.args - list of arguments
* @param Array<*> props.signers - list of signers
*/
export const addToNftCatalog = async (props = {}) => {
  const { addressMap, args = [], signers = [] } = props;
  const code = await addToNftCatalogTemplate(addressMap);

  reportMissing("arguments", args.length, 7, `addToNftCatalog =>`);
  reportMissing("signers", signers.length, 1, `addToNftCatalog =>`);
