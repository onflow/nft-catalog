...
/**
* Method to generate cadence code for ExampleNFT contract
* @param {Object.<string, string>} addressMap - contract name as a key and address where it's deployed as value
*/
export const ExampleNFTTemplate = async (addressMap = {}) => {
  ...
  reportMissingImports(CODE, fullMap, `ExampleNFT =>`)
...
/**
* Deploys ExampleNFT transaction to the network
* @param {Object.<string, string>} addressMap - contract name as a key and address where it's deployed as value
* @param Array<*> args - list of arguments
* param Array<string> - list of signers
*/
export const  deployExampleNFT = async (props) => {
  const { addressMap = {} } = props;
  const code = await ExampleNFTTemplate(addressMap);
