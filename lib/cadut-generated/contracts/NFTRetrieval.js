...
/**
* Method to generate cadence code for NFTRetrieval contract
* @param {Object.<string, string>} addressMap - contract name as a key and address where it's deployed as value
*/
export const NFTRetrievalTemplate = async (addressMap = {}) => {
  ...
  reportMissingImports(CODE, fullMap, `NFTRetrieval =>`)
...
/**
* Deploys NFTRetrieval transaction to the network
* @param {Object.<string, string>} addressMap - contract name as a key and address where it's deployed as value
* @param Array<*> args - list of arguments
* param Array<string> - list of signers
*/
export const  deployNFTRetrieval = async (props) => {
  const { addressMap = {} } = props;
  const code = await NFTRetrievalTemplate(addressMap);
  const name = "NFTRetrieval"
