...
/**
* Method to generate cadence code for NFTCatalog contract
* @param {Object.<string, string>} addressMap - contract name as a key and address where it's deployed as value
*/
export const NFTCatalogTemplate = async (addressMap = {}) => {
  ...
  reportMissingImports(CODE, fullMap, `NFTCatalog =>`)
...
/**
* Deploys NFTCatalog transaction to the network
* @param {Object.<string, string>} addressMap - contract name as a key and address where it's deployed as value
* @param Array<*> args - list of arguments
* param Array<string> - list of signers
*/
export const  deployNFTCatalog = async (props) => {
  const { addressMap = {} } = props;
  const code = await NFTCatalogTemplate(addressMap);
  const name = "NFTCatalog"
