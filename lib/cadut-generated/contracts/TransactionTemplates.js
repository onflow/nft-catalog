...
/**
* Method to generate cadence code for TransactionTemplates transaction
* @param {Object.<string, string>} addressMap - contract name as a key and address where it's deployed as value
*/
export const TransactionTemplatesTemplate = async (addressMap = {}) => {
  ...
  reportMissingImports(CODE, fullMap, `TransactionTemplates =>`)
...
/**
* Sends TransactionTemplates transaction to the network
* @param {Object.<string, string>} props.addressMap - contract name as a key and address where it's deployed as value
* @param Array<*> props.args - list of arguments
* @param Array<*> props.signers - list of signers
*/
export const TransactionTemplates = async (props = {}) => {
  const { addressMap, args = [], signers = [] } = props;
  const code = await TransactionTemplatesTemplate(addressMap);

  reportMissing("arguments", args.length, 3, `TransactionTemplates =>`);
  reportMissing("signers", signers.length, 1, `TransactionTemplates =>`);
