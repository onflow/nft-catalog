...
/**
* Method to generate cadence code for NonStandardNFT contract
* @param {Object.<string, string>} addressMap - contract name as a key and address where it's deployed as value
*/
export const NonStandardNFTTemplate = async (addressMap = {}) => {
  ...
  reportMissingImports(CODE, fullMap, `NonStandardNFT =>`)
...
/**
* Deploys NonStandardNFT transaction to the network
* @param {Object.<string, string>} addressMap - contract name as a key and address where it's deployed as value
* @param Array<*> args - list of arguments
* param Array<string> - list of signers
*/
export const  deployNonStandardNFT = async (props) => {
  const { addressMap = {} } = props;
  const code = await NonStandardNFTTemplate(addressMap);
  const name = "NonStandardNFT"
