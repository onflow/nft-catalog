...
/**
* Method to generate cadence code for NFTCatalogAdmin contract
* @param {Object.<string, string>} addressMap - contract name as a key and address where it's deployed as value
*/
export const NFTCatalogAdminTemplate = async (addressMap = {}) => {
  ...
  reportMissingImports(CODE, fullMap, `NFTCatalogAdmin =>`)
...
/**
* Deploys NFTCatalogAdmin transaction to the network
* @param {Object.<string, string>} addressMap - contract name as a key and address where it's deployed as value
* @param Array<*> args - list of arguments
* param Array<string> - list of signers
*/
export const  deployNFTCatalogAdmin = async (props) => {
  const { addressMap = {} } = props;
  const code = await NFTCatalogAdminTemplate(addressMap);
  const name = "NFTCatalogAdmin"
