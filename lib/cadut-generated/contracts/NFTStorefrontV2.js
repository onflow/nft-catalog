...
/**
* Method to generate cadence code for NFTStorefrontV2 contract
* @param {Object.<string, string>} addressMap - contract name as a key and address where it's deployed as value
*/
export const NFTStorefrontV2Template = async (addressMap = {}) => {
  ...
  reportMissingImports(CODE, fullMap, `NFTStorefrontV2 =>`)
...
/**
* Deploys NFTStorefrontV2 transaction to the network
* @param {Object.<string, string>} addressMap - contract name as a key and address where it's deployed as value
* @param Array<*> args - list of arguments
* param Array<string> - list of signers
*/
export const  deployNFTStorefrontV2 = async (props) => {
  const { addressMap = {} } = props;
  const code = await NFTStorefrontV2Template(addressMap);
  const name = "NFTStorefrontV2"
