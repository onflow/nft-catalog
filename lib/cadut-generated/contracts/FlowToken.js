...
/**
* Method to generate cadence code for FlowToken contract
* @param {Object.<string, string>} addressMap - contract name as a key and address where it's deployed as value
*/
export const FlowTokenTemplate = async (addressMap = {}) => {
  ...
  reportMissingImports(CODE, fullMap, `FlowToken =>`)
...
/**
* Deploys FlowToken transaction to the network
* @param {Object.<string, string>} addressMap - contract name as a key and address where it's deployed as value
* @param Array<*> args - list of arguments
* param Array<string> - list of signers
*/
export const  deployFlowToken = async (props) => {
  const { addressMap = {} } = props;
  const code = await FlowTokenTemplate(addressMap);
